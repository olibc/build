...
HOST_OUT_release := $(HOST_OUT_ROOT_release)
HOST_OUT_debug := $(HOST_OUT_ROOT_debug)
HOST_OUT := $(HOST_OUT_$(HOST_BUILD_TYPE))

BUILD_OUT := $(OUT_DIR)/host

TARGET_PRODUCT_OUT_ROOT := $(TARGET_OUT_ROOT)

TARGET_COMMON_OUT_ROOT := $(TARGET_OUT_ROOT)/common
HOST_COMMON_OUT_ROOT := $(HOST_OUT_ROOT)/common

PRODUCT_OUT := $(TARGET_PRODUCT_OUT_ROOT)
